...
fun <- function (C) {
	...
	form <- amplitude ~ dev*session + s(ppn,bs='re') + s(ppn,by=dev,bs='re') +
		...
		te(lat,lon,time,bs=c('ds','tp'),d=c(2,1),k=c(19,5)) +
...
amplitude ~ dev * session + s(ppn, bs = "re") + s(ppn, by = dev, 
    ...
    bs = "re") + te(lat, lon, time, bs = c("ds", "tp"), d = c(2, 
    1), k = c(19, 5)) + t2(lat, lon, time, ppn, bs = c("sos", 
    "tp", "re"), d = c(2, 1, 1), k = c(19, 5, 5), m = 1, full = TRUE)

Parametric coefficients:
            Estimate Std. Error t value Pr(>|t|)    
(Intercept)   0.7114     0.1717   4.144 3.41e-05 ***
dev          -0.8848     0.2258  -3.918 8.94e-05 ***
session      -0.3645     0.1607  -2.268   0.0233 *  
dev:session  -0.1792     0.3444  -0.520   0.6029    
---
Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1

Approximate significance of smooth terms:
                          edf Ref.df         F  p-value    
s(ppn)                  4.251   26.0     0.281 2.07e-08 ***
s(ppn):dev             25.866   26.0 17770.409  < 2e-16 ***
s(ppn):session         18.909   20.0 13852.315  < 2e-16 ***
s(ppn):both            19.715   20.0 17369.745  < 2e-16 ***
te(lat,lon,time)       76.709   81.1    24.770  < 2e-16 ***
t2(lat,lon,time,ppn) 1683.345 2538.0  4778.133  < 2e-16 ***
---
Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1

R-sq.(adj) =  0.773   Deviance explained = 77.6%
fREML = -65303  Scale est. = 0.1731    n = 111325
...
Parametric coefficients:
            Estimate Std. Error t value Pr(>|t|)    
(Intercept)  0.87631    0.19204   4.563 5.05e-06 ***
dev         -1.09572    0.22363  -4.900 9.61e-07 ***
session     -0.58793    0.18237  -3.224  0.00127 ** 
dev:session -0.08204    0.24846  -0.330  0.74124    
---
Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1

Approximate significance of smooth terms:
                         edf  Ref.df        F  p-value    
s(ppn)                 18.85   26.00    5.653  < 2e-16 ***
s(ppn):dev             25.78   26.00 5782.511  < 2e-16 ***
s(ppn):session         19.02   20.00 4540.367 2.86e-12 ***
s(ppn):both            19.30   20.00 9086.087 3.61e-15 ***
te(lat,lon,time)       73.01   78.71   10.987  < 2e-16 ***
t2(lat,lon,time,ppn) 1511.36 2545.00  792.788 4.94e-07 ***
---
Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1

R-sq.(adj) =  0.653   Deviance explained = 65.9%
fREML = -30494  Scale est. = 0.2966    n = 111203
')
```
